/* ============================================================
   Kampaňová landing page /zamietnute-poistne-plnenie.
   Slovak-only by design — cieľová skupina sú slovenskí poistníci,
   konanie sa vedie na diaľku, takže kampaň ide na celú SR.

   Copy musí obstáť voči § 29b zák. 586/2003 o advokácii: len
   vecné objektívne informácie, žiadne porovnávanie s inými
   advokátmi, žiadne sľuby výsledku. Honorárový model odkazuje
   na § 7 ods. 2 a § 8 vyhl. 655/2004 (podielová odmena max 20 %
   z hodnoty veci, nárok len pri plnom úspechu; pri neúspechu
   sa hradia hotové výdavky — preto sa nikde netvrdí, že klient
   pri prehre neplatí nič).
   ============================================================ */
...
/* --- Typické dôvody zamietnutia, ktoré sa oplatí preveriť --- */

export const CLAIM_REASONS: { title: string; desc: string }[] = [
  {
...
export const CLAIM_TYPES: string[] = [
...
export const CLAIM_STEPS: { title: string; desc: string }[] = [
  {
...
/* --- FAQ (ide aj do FAQPage štruktúrovaných dát) --- */

export const CLAIM_FAQ: { q: string; a: string }[] = [
  {
