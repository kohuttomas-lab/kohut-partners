...
const BLOG: RawArticle[] = [
  {
    id: "prihlaska-pohladavky-do-konkurzu-lehoty-a-chyby",
    cat: { sk: "Insolvencie", en: "Insolvency" },
    tone: "brand",
    read: 4,
    date: { sk: "21. septembra 2026", en: "21 September 2026" },
    iso: "2026-09-21T09:00:00+02:00",
    sk: ["Prihláška pohľadávky do konkurzu: lehoty a chyby", "Zmeškaná lehota alebo chyba v prihláške môže znamenať stratu peňazí. Prečítajte si, na čo si dať pozor pri prihlasovaní pohľadávky do konkurzu."],
    en: ["Filing a Claim in Bankruptcy: Deadlines and Errors", "A missed deadline or an error in your filing can mean losing your money. Learn what to watch out for when filing a claim in bankruptcy."],
    body: {
      sk: ["Keď sa váš dlžník dostane do konkurzu, jediný spôsob, ako sa domáhať svojich peňazí, je včas a správne prihlásiť pohľadávku. Prihláška sa podáva správcovi konkurznej podstaty a rozhoduje o tom, či budete v konkurze vôbec braní do úvahy ako veriteľ.","Najdôležitejšia je lehota. Na prihlásenie pohľadávky máte spravidla presne stanovený čas, ktorý začína plynúť od vyhlásenia konkurzu. Ak túto lehotu zmeškáte, vaše postavenie sa výrazne zhorší a v niektorých prípadoch môžete o možnosť uspokojenia úplne prísť. Preto odporúčame konať hneď, ako sa o konkurze dozviete, a nespoliehať sa na to, že vás niekto vyzve.","Časté chyby vznikajú už pri samotnom vyplnení prihlášky. Veritelia neuvádzajú presnú výšku pohľadávky, zabúdajú rozlíšiť istinu a príslušenstvo, nesprávne určia právny dôvod vzniku pohľadávky alebo nepriložia doklady, ktoré nárok preukazujú. Takéto nedostatky môžu viesť k tomu, že správca pohľadávku poprie.","Ďalším rizikom je prehliadnutie zabezpečenia pohľadávky. Ak máte nárok zabezpečený napríklad záložným právom, je potrebné to v prihláške riadne uplatniť a preukázať. Ak to opomeniete, môžete stratiť výhodnejšie postavenie, ktoré by vám inak zabezpečilo lepšie uspokojenie.","Odporúčame tiež uchovať si potvrdenie o podaní a sledovať priebeh konkurzu. Ak správca vašu pohľadávku poprie, na obranu svojich práv máte opäť len obmedzený čas. Pasivita v tejto fáze býva rovnako nebezpečná ako zmeškanie pôvodnej lehoty na prihlásenie.","Ak si nie ste istí, či je vaša prihláška úplná a podaná správne, radi vám pomôžeme. V kancelárii Kohút & Partners vo Zvolene pripravíme alebo skontrolujeme vašu prihlášku za vopred dohodnutú pevnú cenu a na váš dopyt odpovieme do 24 hodín."],
      en: ["When your debtor enters bankruptcy, the only way to pursue your money is to file your claim on time and correctly. The filing is submitted to the bankruptcy trustee and determines whether you will be considered a creditor in the proceedings at all.","The deadline is the most important thing. You usually have a clearly defined period to file your claim, which begins to run from the declaration of bankruptcy. If you miss this deadline, your position significantly worsens and in some cases you may lose the chance of satisfaction entirely. That is why we recommend acting as soon as you learn about the bankruptcy and not relying on someone to notify you.","Common errors arise already when completing the filing itself. Creditors fail to state the exact amount of the claim, forget to distinguish the principal from its accessories, incorrectly determine the legal grounds for the claim, or fail to attach the documents that prove the claim. Such shortcomings may lead the trustee to deny the claim.","Another risk is overlooking the security of the claim. If your claim is secured, for example by a lien, you must properly assert and prove this in the filing. If you omit it, you may lose the more favourable position that would otherwise ensure better satisfaction.","We also recommend keeping proof of submission and monitoring the course of the bankruptcy. If the trustee denies your claim, you again have only a limited time to defend your rights. Passivity at this stage can be just as dangerous as missing the original filing deadline.","If you are unsure whether your filing is complete and correctly submitted, we are happy to help. At Kohút & Partners in Zvolen, we will prepare or review your filing for an agreed fixed price and respond to your inquiry within 24 hours."],
    },
  },
  {
    id: "restrukturalizacia-firmy-2026-podmienky-a-priebeh",
    cat: { sk: "Insolvencie", en: "Insolvency" },
    tone: "brand",
    read: 4,
    date: { sk: "14. septembra 2026", en: "14 September 2026" },
    iso: "2026-09-14T09:00:00+02:00",
    sk: ["Reštrukturalizácia firmy 2026: podmienky a priebeh", "Firma v problémoch nemusí končiť konkurzom. Zistite, kedy je reštrukturalizácia možná a ako prebieha krok po kroku."],
    en: ["Company Restructuring 2026: Conditions and Process", "A troubled company doesn't have to end in bankruptcy. Learn when restructuring is possible and how it works step by step."],
    body: {
      sk: ["Reštrukturalizácia je právny nástroj, ktorý umožňuje firme v ťažkostiach vyhnúť sa konkurzu a pokračovať v podnikaní. Namiesto rozpredaja majetku a zániku spoločnosti sa hľadá spôsob, ako ozdraviť financie, dohodnúť sa s veriteľmi a postupne splatiť časť záväzkov. Cieľom je zachovať fungujúci podnik, pracovné miesta a hodnotu, ktorá by inak pri konkurze zanikla.","Základnou podmienkou je, že podnik musí byť reálne životaschopný – teda musí existovať perspektíva, že po ozdravení bude schopný fungovať a plniť si nové záväzky. Reštrukturalizácia sa spravidla využíva vtedy, keď firma čelí hroziacej alebo už existujúcej platobnej neschopnosti, no jej ekonomický základ je stále zdravý. Ak podnik nemá žiadnu perspektívu ďalšieho fungovania, býva namiesto toho vhodnejším riešením konkurz.","Priebeh sa zjednodušene dá rozdeliť do niekoľkých fáz. Najprv je potrebné poctivé posúdenie stavu firmy a vypracovanie plánu, ktorý ukazuje, ako sa podnik ozdraví a ako budú uspokojení veritelia. Následne sa proces vedie pod dohľadom súdu a povereného správcu, veritelia sa k plánu vyjadrujú a hlasujú oň. Ak je plán schválený a potvrdený, stáva sa záväzným pre firmu aj pre dotknutých veriteľov.","V praxi je kľúčová rýchlosť a otvorená komunikácia. Čím skôr firma svoje problémy prizná a začne konať, tým väčšia je šanca na úspech – neskoré riešenie často znamená stratu dôvery veriteľov a menej priestoru na dohodu. Dôležitá je aj kvalitná príprava dokumentov a realistický plán, ktorý veriteľov presvedčí, že sa im oplatí firme dať priestor namiesto konkurzu.","Reštrukturalizácia nie je len o číslach, ale aj o dôslednom dodržaní právnych postupov a lehôt. Chyba v procese alebo nepresvedčivý plán môžu celé úsilie zmariť. Preto sa oplatí mať po boku niekoho, kto pozná nielen zákon, ale aj praktický priebeh rokovaní s veriteľmi a súdom.","Ak zvažujete, či je reštrukturalizácia pre vašu firmu vhodným riešením, ozvite sa nám. V kancelárii Kohút & Partners vo Zvolene vám situáciu posúdime za pevne dohodnutú cenu a na vašu otázku odpovieme do 24 hodín. Čím skôr začneme, tým viac možností budete mať."],
      en: ["Restructuring is a legal tool that allows a troubled company to avoid bankruptcy and continue operating. Instead of selling off assets and dissolving the company, the aim is to restore its finances, reach an agreement with creditors and gradually repay part of its debts. The goal is to preserve a functioning business, jobs and the value that would otherwise be lost in bankruptcy.","The basic condition is that the business must be genuinely viable – there must be a realistic prospect that, after recovery, it will be able to operate and meet its new obligations. Restructuring is generally used when a company faces impending or existing insolvency, but its economic foundation is still sound. If the business has no prospect of continuing, bankruptcy is usually the more appropriate solution instead.","The process can be simplified into several phases. First, an honest assessment of the company's condition is needed, along with a plan showing how the business will recover and how creditors will be satisfied. The process is then carried out under the supervision of the court and an appointed administrator, with creditors commenting on the plan and voting on it. Once the plan is approved and confirmed, it becomes binding on both the company and the affected creditors.","In practice, speed and open communication are key. The sooner a company admits its problems and starts acting, the greater the chance of success – late action often means loss of creditor trust and less room for agreement. Quality preparation of documents and a realistic plan that convinces creditors it is worth giving the company a chance instead of bankruptcy are also essential.","Restructuring is not only about numbers, but also about strictly following legal procedures and deadlines. A mistake in the process or an unconvincing plan can undermine the entire effort. That is why it pays to have someone by your side who knows not only the law, but also the practical course of negotiations with creditors and the court.","If you are considering whether restructuring is the right solution for your company, get in touch with us. At Kohút & Partners in Zvolen, we will assess your situation for a firmly agreed price and answer your question within 24 hours. The sooner we start, the more options you will have."],
    },
  },
  {
    id: "trestne-oznamenie-vs-podanie-na-policiu",
    cat: { sk: "Trestné právo", en: "Criminal Law" },
    tone: "brand",
    read: 4,
    date: { sk: "7. septembra 2026", en: "7 September 2026" },
    iso: "2026-09-07T09:00:00+02:00",
    sk: ["Trestné oznámenie vs. podanie na políciu", "Neviete, či podať trestné oznámenie alebo obyčajné podanie? Poradíme, čo, kedy a ako správne urobiť, aby ste neprišli o svoje práva."],
    en: ["Criminal Complaint vs. Police Filing", "Not sure whether to file a criminal complaint or a simple filing? We explain what, when and how to do it right so you don't lose your rights."],
    body: {
      sk: ["Mnohí ľudia si zamieňajú pojmy „trestné oznámenie“ a „podanie na políciu“. V praxi ide o dve rôzne veci, ktoré majú odlišný cieľ aj následky. Kým podanie môže byť akákoľvek žiadosť, otázka alebo informácia smerovaná orgánom, trestné oznámenie je konkrétny podnet, ktorým upozorňujete na skutočnosti nasvedčujúce spáchaniu trestného činu.","Trestné oznámenie má zmysel vtedy, keď sa domnievate, že došlo k činu, ktorý zákon označuje za trestný – napríklad podvod, krádež, ublíženie na zdraví alebo vyhrážanie. Nemusíte pritom presne vedieť, o aký trestný čin ide ani kto ho spáchal. Dôležité je jasne opísať, čo sa stalo, kedy a kde, a priložiť dostupné dôkazy, ako sú fotografie, správy, e-maily či mená svedkov.","Trestné oznámenie môžete podať písomne, ústne do zápisnice na policajnom útvare alebo na prokuratúre. Odporúčame vždy uchovať si kópiu alebo potvrdenie o prijatí. Ak podávate oznámenie ústne, žiadajte o vyhotovenie zápisnice a jej odpis. Anonymné podanie je síce možné, no orgány ho nemusia preveriť rovnako dôsledne ako oznámenie s uvedenou totožnosťou.","Po prijatí oznámenia sú orgány povinné vec preveriť a rozhodnúť o ďalšom postupe. Ako oznamovateľ máte právo byť informovaný o tom, ako bolo s vaším podnetom naložené. Ak s výsledkom nesúhlasíte, v mnohých prípadoch je možné podať opravný prostriedok. Práve tu sa často rozhoduje, či bude vaša vec úspešná – preto sa oplatí vedieť, aké lehoty a možnosti máte.","Časté chyby laikov sú nejasný opis skutku, chýbajúce dôkazy alebo zmeškanie lehôt na reakciu. Nesprávne podanie môže celý proces zbytočne predĺžiť alebo oslabiť vašu pozíciu. Preto sa vyplatí premyslieť si obsah oznámenia dopredu a v zložitejších prípadoch sa poradiť s odborníkom, ktorý vám pomôže formulovať ho tak, aby malo reálnu váhu.","Ak si nie ste istí, či a ako podať trestné oznámenie, radi vám pomôžeme. V advokátskej kancelárii Kohút & Partners vo Zvolene ponúkame konzultáciu za pevnú cenu a s odpoveďou do 24 hodín. Ozvite sa nám a spoločne nájdeme najlepší postup pre vašu situáciu."],
      en: ["Many people confuse the terms \"criminal complaint\" and \"filing with the police\". In practice these are two different things with different goals and consequences. While a filing can be any request, question or piece of information addressed to the authorities, a criminal complaint is a specific report drawing attention to facts indicating that a crime has been committed.","A criminal complaint makes sense when you believe an act has occurred that the law considers a crime – for example fraud, theft, bodily harm or making threats. You do not need to know exactly which crime it is or who committed it. What matters is to clearly describe what happened, when and where, and to attach any available evidence such as photographs, messages, e-mails or names of witnesses.","You can file a criminal complaint in writing, orally on the record at a police unit, or at the prosecutor's office. We always recommend keeping a copy or a confirmation of receipt. If you file the complaint orally, ask for a record to be drawn up and for a copy of it. An anonymous filing is possible, but the authorities may not investigate it as thoroughly as a complaint with a stated identity.","After receiving the complaint, the authorities are obliged to examine the matter and decide on further steps. As the person filing, you have the right to be informed about how your report was handled. If you disagree with the outcome, in many cases it is possible to file an appeal. This is often where the success of your case is decided – so it pays to know what deadlines and options you have.","Common mistakes made by laypeople include an unclear description of the act, missing evidence or missing deadlines for a response. An incorrect filing can needlessly prolong the whole process or weaken your position. That is why it is worth thinking through the content of the complaint in advance and, in more complex cases, consulting an expert who will help you phrase it so that it carries real weight.","If you are unsure whether and how to file a criminal complaint, we will be glad to help. At the law firm Kohút & Partners in Zvolen we offer a consultation at a fixed price and with a reply within 24 hours. Get in touch and together we will find the best approach for your situation."],
    },
  },
  {
    id: "ako-sa-branit-neopravnenej-exekucii",
    cat: { sk: "Súdne spory", en: "Litigation" },
    tone: "brand",
    read: 4,
    date: { sk: "31. augusta 2026", en: "31 August 2026" },
    iso: "2026-08-31T09:00:00+02:00",
    sk: ["Ako sa brániť neoprávnenej exekúcii", "Prišla vám exekúcia, ktorú považujete za neoprávnenú? Prečítajte si, aké kroky môžete podniknúť a ako ochrániť svoj majetok."],
    en: ["How to Defend Against an Unlawful Execution", "Received an execution you believe is unjustified? Learn what steps you can take and how to protect your property."],
    body: {
      sk: ["Neoprávnená exekúcia dokáže spôsobiť množstvo starostí – zablokovaný účet, zrážky zo mzdy či ohrozenie majetku. Niekedy ide o dávno premlčaný dlh, inokedy o pohľadávku, ktorá už bola zaplatená, alebo dokonca o zámenu osôb. Dôležité je nezostať pasívny a konať čo najskôr.","Prvým krokom je pozorne si preštudovať doručené dokumenty. Z upovedomenia o začatí exekúcie zistíte, kto je oprávnený (veriteľ), na základe akého rozhodnutia sa exekúcia vedie a aká suma sa vymáha. Overte si, či dlh skutočne existuje, či ste ho už nesplatili a či nie je premlčaný. Odložte si všetky doklady o prípadných platbách.","Ak máte za to, že exekúcia je neoprávnená, zákon vám umožňuje brániť sa. V určitých lehotách je možné podať námietky alebo návrh na zastavenie exekúcie a požiadať o odklad, kým sa vec posúdi. Tieto lehoty sú spravidla krátke, preto je rozumné konať bezodkladne – premeškanie lehoty môže výrazne skomplikovať vašu obranu.","Komunikujte aj so súdnym exekútorom, no vždy písomne a s uchovaním kópií. Nikdy nepodpisujte dohody či uznanie dlhu bez toho, aby ste si boli istí, že dlh naozaj existuje. Ak nie ste si istí správnosťou postupu, nechajte si dokumenty posúdiť skôr, než čokoľvek uhradíte alebo podpíšete.","Každý prípad je individuálny a úspech obrany často závisí od detailov a dodržania lehôt. Práve preto sa oplatí obrátiť sa na advokáta, ktorý dokáže rýchlo vyhodnotiť vaše možnosti a navrhnúť najvhodnejší postup, aby ste zbytočne neprišli o peniaze či majetok.","Ak riešite exekúciu, ktorú považujete za neoprávnenú, radi vám pomôžeme. V kancelárii Kohút & Partners vo Zvolene vám ponúkame posúdenie za pevne dohodnutú cenu a na vašu otázku sa vám ozveme do 24 hodín. Ozvite sa nám a získajte jasno vo svojej situácii."],
      en: ["An unlawful execution can cause a great deal of trouble – a blocked account, wage deductions, or a threat to your property. Sometimes it concerns a long-barred debt, other times a claim that has already been paid, or even a case of mistaken identity. The important thing is not to remain passive and to act as soon as possible.","The first step is to carefully review the documents you received. From the notice of commencement of execution you will learn who the entitled party (creditor) is, on the basis of which decision the execution is being carried out, and what amount is being claimed. Verify whether the debt actually exists, whether you have already paid it, and whether it is time-barred. Keep all records of any payments.","If you believe the execution is unlawful, the law allows you to defend yourself. Within certain deadlines it is possible to file objections or a motion to stop the execution and request a postponement while the matter is assessed. These deadlines are usually short, so it is wise to act without delay – missing a deadline can significantly complicate your defence.","Communicate with the court executor as well, but always in writing and keep copies. Never sign agreements or acknowledgements of debt without being certain that the debt truly exists. If you are unsure about the correctness of the procedure, have the documents reviewed before you pay or sign anything.","Every case is individual and the success of a defence often depends on details and meeting deadlines. That is precisely why it is worth turning to a lawyer who can quickly assess your options and propose the most suitable approach, so that you do not needlessly lose money or property.","If you are dealing with an execution you believe is unlawful, we are happy to help. At Kohút & Partners in Zvolen we offer an assessment for a firmly agreed price and we will respond to your question within 24 hours. Get in touch with us and gain clarity about your situation."],
    },
  },
  {
