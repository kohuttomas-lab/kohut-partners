...
export const routing = defineRouting({
  ...
  pathnames: {
    ...
    "/debt-relief-bankruptcy": { sk: "/oddlzenie-konkurzom", en: "/debt-relief-bankruptcy" },
    "/debt-relief-repayment-plan": { sk: "/oddlzenie-splatkovym-kalendarom", en: "/debt-relief-repayment-plan" },
    "/payment-order-objection": { sk: "/odpor-proti-platobnemu-rozkazu", en: "/payment-order-objection" },
    "/criminal-defense": { sk: "/obhajoba-v-trestnom-konani", en: "/criminal-defense" },
    "/drink-driving": { sk: "/alkohol-za-volantom", en: "/drink-driving" },
    "/rejected-warranty-claim": { sk: "/neuznana-reklamacia", en: "/rejected-warranty-claim" },
    "/trade-licence-advice": { sk: "/zivnost-alebo-sro", en: "/trade-licence-advice" },
    "/legal-consultation": { sk: "/pravna-konzultacia", en: "/legal-consultation" },
    "/payment-order": { sk: "/platobny-rozkaz", en: "/payment-order" },
