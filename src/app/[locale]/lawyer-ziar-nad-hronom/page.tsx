...
export async function generateMetadata(props: Props): Promise<Metadata> {
  ...
  if (!isAvailableIn("/lawyer-ziar-nad-hronom", locale)) return {};
  ...
  return {
    ...
    alternates: localeAlternates(locale, "/lawyer-ziar-nad-hronom"),
    openGraph: {
      type: "website",
...
export default async function Page(props: Props) {
  const { locale } = await props.params;
  if (!isAvailableIn("/lawyer-ziar-nad-hronom", locale)) notFound();
