...
export async function generateMetadata(props: Props): Promise<Metadata> {
  ...
  if (!isAvailableIn("/lawyer-krupina", locale)) return {};
  ...
  return {
    ...
    alternates: localeAlternates(locale, "/lawyer-krupina"),
    openGraph: {
      type: "website",
...
export default async function Page(props: Props) {
  const { locale } = await props.params;
  if (!isAvailableIn("/lawyer-krupina", locale)) notFound();
